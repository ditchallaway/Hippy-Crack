...
const page = () => html`
  <h1>💾 Setting Up a Service Worker<code class="badge ml-12 green text-white">+v0.6</code></h1>
  <hr>
  <p>
  ...
  <h2 id="versioning-your-service-worker-cache">Versioning your Service Worker cache<code class="badge ml-12">+v0.9</code></h2>
  <p>
